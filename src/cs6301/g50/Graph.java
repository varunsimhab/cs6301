...
public class Graph implements Iterable<Graph.Vertex> {
	...
	public static class Vertex implements Iterable<Edge> {
		...
		List<Edge> revAdj; // adjacency list; use LinkedList or ArrayList
		...
		/*
            Method to get the Out-Degree of the vertex
            */
		...
		/*
        Method to get the In-Degree of the vertex
        */
	 ...
	 */
	public ArrayIterator<Vertex> iterator() {
